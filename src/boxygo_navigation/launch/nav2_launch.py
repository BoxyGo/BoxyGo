...
def generate_launch_description():
    ...
    map_file = os.path.join(boxygo_localization_pkg, 'maps', 'mapa_agh.yaml') # playground_map.yaml / map.yaml
    params_file = os.path.join(boxygo_navigation_pkg, 'config', 'nav2_nvblox_params_mppi.yaml') # nav2_real_param_inside.yaml / nav2_real_param_outside.yaml
